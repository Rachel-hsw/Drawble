...
public class MainActivity extends Activity implements CompoundButton.OnCheckedChangeListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvLayers = findViewById(R.id.iv_layers);
        mIvScale = findViewById(R.id.iv_scale);
        mCbNinePatch = findViewById(R.id.cb_nine_patch);
        mTvShow9 = findViewById(R.id.tv_show9);
        mIvLevers = findViewById(R.id.iv_levers);
        mCbLayers = findViewById(R.id.cb_layers);
        mCbStates = findViewById(R.id.cb_states);
        mBtnLever6 = findViewById(R.id.btn_lever_6);
        mBtnLever14 = findViewById(R.id.btn_lever_14);
